        ...
        if (dir.isDirectory()) {
            ...
            dir.eachFileRecurse { File file ->
                ...
                if (file.getName().equals("MainActivity.class")) {
                    ...
                    CtClass ctClass = pool.getCtClass("com.gar.plugin.MainActivity");
                    ...
                    System.out.println("方法名 = " + ctMethod)

                    String insetBeforeStr = """ android.widget.Toast.makeText(this,"我是被插了的Toast代码",android.widget.Toast.LENGTH_SHORT).show();
                                                """
                    //在方法开头插入代码
